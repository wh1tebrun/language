...
const wordPairs = [
    { russian: "информатика", english: "computer science" },
    { russian: "компьютер", english: "computer" },
    { russian: "программист", english: "programmer" },
    { russian: "программистка", english: "female programmer" },
    { russian: "программное обеспечение", english: "software" },
    { russian: "аппаратное обеспечение", english: "hardware" },
    { russian: "алгоритм", english: "algorithm" },
    { russian: "программа", english: "program" },
    { russian: "код", english: "code" },
    { russian: "язык программирования", english: "programming language" },
    { russian: "сеть", english: "network" },
    { russian: "сервер", english: "server" },
    { russian: "база данных", english: "database" },
    { russian: "операционная система", english: "operating system" },
    { russian: "интерфейс", english: "interface" },
    { russian: "пользователь", english: "user" },
    { russian: "пользовательница", english: "female user" },
    { russian: "облако", english: "cloud" },
    { russian: "интернет", english: "internet" },
    { russian: "веб-сайт", english: "website" },
    { russian: "браузер", english: "browser" },
    { russian: "пароль", english: "password" },
    { russian: "шифрование", english: "encryption" },
    { russian: "бит", english: "bit" },
    { russian: "байт", english: "byte" },
    { russian: "компилятор", english: "compiler" },
    { russian: "процессор", english: "processor" },
    { russian: "память", english: "memory" },
    { russian: "оперативная память (RAM)", english: "RAM" },
    { russian: "жесткий диск", english: "hard drive" },
    { russian: "кэш", english: "cache" },
    { russian: "протокол", english: "protocol" },
    { russian: "сетевой протокол", english: "network protocol" },
    { russian: "фаервол", english: "firewall" },
    { russian: "вирус", english: "virus" },
    { russian: "баг", english: "bug" },
    { russian: "отладка", english: "debugging" },
    { russian: "приложение", english: "application" },
    { russian: "операционная система", english: "operating system" },
    { russian: "искусственный интеллект", english: "artificial intelligence" },
    { russian: "машинное обучение", english: "machine learning" },
    { russian: "набор данных", english: "data set" },
    { russian: "функция", english: "function" },
    { russian: "модуль", english: "module" },
    { russian: "переменная", english: "variable" },
    { russian: "массив", english: "array" },
    { russian: "цикл", english: "loop" },
    { russian: "структура данных", english: "data structure" },
    { russian: "стек", english: "stack" }
];

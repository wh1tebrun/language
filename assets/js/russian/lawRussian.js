...
const wordPairs = [
    ...
    { russian: "адвокат", english: "lawyer" },
    { russian: "адвокатесса", english: "female lawyer" },
    { russian: "судья", english: "judge" },
    { russian: "судья (женщина)", english: "female judge" },
    { russian: "суд", english: "court" },
    { russian: "судебный процесс", english: "trial" },
    { russian: "иск", english: "lawsuit" },
    { russian: "приговор", english: "verdict" },
    { russian: "договор", english: "contract" },
    { russian: "конституция", english: "constitution" },
    { russian: "право", english: "right" },
    { russian: "обязанность", english: "duty" },
    { russian: "преступление", english: "criminal offense" },
    { russian: "уголовное право", english: "criminal law" },
    { russian: "гражданское право", english: "civil law" },
    { russian: "семейное право", english: "family law" },
    { russian: "трудовое право", english: "labor law" },
    { russian: "собственность", english: "property" },
    { russian: "документ", english: "document" },
    { russian: "сторона по договору", english: "contracting party" },
    { russian: "свидетель", english: "witness" },
    { russian: "свидетельница", english: "female witness" },
    { russian: "доказательство", english: "evidence" },
    { russian: "переговоры", english: "negotiation" },
    { russian: "апелляция", english: "appeal" },
    { russian: "истец", english: "plaintiff" },
    { russian: "истица", english: "female plaintiff" },
    { russian: "обвиняемый", english: "defendant" },
    { russian: "наказание", english: "punishment" },
    { russian: "штраф", english: "fine" },
    { russian: "преступление", english: "crime" },
    { russian: "заключение под стражу", english: "custody" },
    { russian: "договор", english: "contract" },
    { russian: "компенсация", english: "compensation" },
    { russian: "ответственность", english: "liability" },
    { russian: "судебное решение", english: "judgment" },
    { russian: "регламент", english: "regulation" },
    { russian: "юрист", english: "attorney" },
    { russian: "защита", english: "defense" },
    { russian: "обвинение", english: "accusation" },
    { russian: "справедливость", english: "justice" },
    { russian: "возмещение ущерба", english: "damages" },
    { russian: "трудовой закон", english: "labor law" },
    { russian: "авторское право", english: "copyright" },
    { russian: "патентное право", english: "patent law" },
    { russian: "правовая норма", english: "legal norm" },
    { russian: "законодательство", english: "legislation" }
];

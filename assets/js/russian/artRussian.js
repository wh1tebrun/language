...
const wordPairs = [
    ...
    { russian: "картина", english: "painting" },
    { russian: "скульптура", english: "sculpture" },
    { russian: "рисунок", english: "drawing" },
    { russian: "фотография", english: "photography" },
    { russian: "произведение искусства", english: "artwork" },
    { russian: "кисть", english: "paintbrush" },
    { russian: "холст", english: "canvas" },
    { russian: "цвет/краска", english: "color/paint" },
    { russian: "акварель", english: "watercolor" },
    { russian: "коллаж", english: "collage" },
    { russian: "портрет", english: "portrait" },
    { russian: "выставка", english: "exhibition" },
    { russian: "галерея", english: "gallery" },
    { russian: "художественный стиль", english: "art style" },
    { russian: "реализм", english: "realism" },
    { russian: "импрессионизм", english: "impressionism" },
    { russian: "экспрессионизм", english: "expressionism" },
    { russian: "сюрреализм", english: "surrealism" },
    { russian: "абстрактное искусство", english: "abstract art" },
    { russian: "современное искусство", english: "modern art" },
    { russian: "натюрморт", english: "still life" },
    { russian: "скульптурное искусство", english: "sculpture (craft)" },
    { russian: "инсталляция", english: "installation" },
    { russian: "перформанс", english: "performance" },
    { russian: "художественный музей", english: "art museum" },
    { russian: "эстетика", english: "aesthetics" },
    { russian: "дизайн", english: "design" },
    { russian: "кубизм", english: "cubism" },
    { russian: "авангард", english: "avant-garde" },
    { russian: "мозаика", english: "mosaic" },
    { russian: "керамика", english: "ceramics" },
    { russian: "изобразительное искусство", english: "fine arts" },
    { russian: "история искусства", english: "art history" },
    { russian: "фреска", english: "fresco" },
    { russian: "арт-критик", english: "art critic" },
    { russian: "вдохновение", english: "inspiration" },
    { russian: "креативность", english: "creativity" },
    { russian: "ателье", english: "studio" },
    { russian: "автопортрет", english: "self-portrait" },
    { russian: "графика", english: "graphic" },
    { russian: "эскиз", english: "sketch" },
    { russian: "ксилография", english: "woodcut" },
    { russian: "эскиз/дизайн", english: "draft/design" },
    { russian: "плакат", english: "poster" },
    { russian: "граффити", english: "graffiti" },
    { russian: "куратор", english: "curator" },
    { russian: "композиция", english: "composition" }
];

...
const wordPairs = [
    { italian: "la psicologia", english: "psychology" },
    { italian: "lo psicologo", english: "psychologist" },
    { italian: "la psiche", english: "psyche" },
    { italian: "il comportamento", english: "behavior" },
    { italian: "l'emozione", english: "emotion" },
    { italian: "la coscienza", english: "consciousness" },
    { italian: "il subconscio", english: "subconscious" },
    { italian: "la percezione", english: "perception" },
    { italian: "la memoria", english: "memory" },
    { italian: "il pensiero", english: "thought" },
    { italian: "il sentimento", english: "feeling" },
    { italian: "il sogno", english: "dream" },
    { italian: "lo stress", english: "stress" },
    { italian: "l'ansia", english: "anxiety" },
    { italian: "la depressione", english: "depression" },
    { italian: "la motivazione", english: "motivation" },
    { italian: "il trauma", english: "trauma" },
    { italian: "la terapia", english: "therapy" },
    { italian: "la terapia cognitivo-comportamentale", english: "cognitive behavioral therapy" },
    { italian: "il terapeuta", english: "therapist" },
    { italian: "la diagnosi", english: "diagnosis" },
    { italian: "l'autostima", english: "self-confidence" },
    { italian: "l'autovalutazione", english: "self-esteem" },
    { italian: "l'io", english: "ego" },
    { italian: "l'es", english: "id" },
    { italian: "il super-io", english: "superego" },
    { italian: "il conflitto", english: "conflict" },
    { italian: "l'affrontare", english: "coping" },
    { italian: "la personalità", english: "personality" },
    { italian: "il comportamento", english: "behavior" },
    { italian: "lo sviluppo", english: "development" },
    { italian: "l'esperimento", english: "experiment" },
    { italian: "l'emozione", english: "emotion" },
    { italian: "il bisogno", english: "need" },
    { italian: "la percezione", english: "perception" },
    { italian: "l'inconscio", english: "unconscious" },
    { italian: "l'istinto", english: "instinct" },
    { italian: "l'intelligenza", english: "intelligence" },
    { italian: "il QI", english: "IQ" },
    { italian: "il comportamento", english: "behavior" },
    { italian: "il disturbo", english: "disorder" },
    { italian: "la schizofrenia", english: "schizophrenia" },
    { italian: "la dipendenza", english: "addiction" },
    { italian: "il test", english: "test" },
    { italian: "l'esperimento", english: "experiment" },
    { italian: "la dinamica di gruppo", english: "group dynamics" },
    { italian: "la motivazione", english: "motivation" },
    { italian: "la cognizione", english: "cognition" },
    { italian: "l'apprendimento", english: "learning" }
];

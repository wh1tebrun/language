...
const wordPairs = [
    ...
    { french: "le dessin", english: "drawing" },
    { french: "la photographie", english: "photography" },
    { french: "l'œuvre d'art", english: "artwork" },
    { french: "le pinceau", english: "paintbrush" },
    { french: "la toile", english: "canvas" },
    { french: "la couleur", english: "color/paint" },
    { french: "l'aquarelle", english: "watercolor" },
    { french: "le collage", english: "collage" },
    { french: "le portrait", english: "portrait" },
    { french: "l'exposition", english: "exhibition" },
    { french: "la galerie", english: "gallery" },
    { french: "le style artistique", english: "art style" },
    { french: "le réalisme", english: "realism" },
    { french: "l'impressionnisme", english: "impressionism" },
    { french: "l'expressionnisme", english: "expressionism" },
    { french: "le surréalisme", english: "surrealism" },
    { french: "l'art abstrait", english: "abstract art" },
    { french: "l'art moderne", english: "modern art" },
    { french: "la nature morte", english: "still life" },
    { french: "la sculpture", english: "sculpture (craft)" },
    { french: "l'installation", english: "installation" },
    { french: "la performance", english: "performance" },
    { french: "le musée d'art", english: "art museum" },
    { french: "l'esthétique", english: "aesthetics" },
    { french: "le design", english: "design" },
    { french: "le cubisme", english: "cubism" },
    { french: "l'avant-garde", english: "avant-garde" },
    { french: "la mosaïque", english: "mosaic" },
    { french: "la céramique", english: "ceramics" },
    { french: "les beaux-arts", english: "fine arts" },
    { french: "l'histoire de l'art", english: "art history" },
    { french: "la fresque", english: "fresco" },
    { french: "le critique d'art", english: "art critic" },
    { french: "l'inspiration", english: "inspiration" },
    { french: "la créativité", english: "creativity" },
    { french: "l'atelier", english: "studio" },
    { french: "l'autoportrait", english: "self-portrait" },
    { french: "le graphisme", english: "graphic" },
    { french: "le croquis", english: "sketch" },
    { french: "la gravure sur bois", english: "woodcut" },
    { french: "le projet", english: "draft/design" },
    { french: "l'affiche", english: "poster" },
    { french: "le graffiti", english: "graffiti" },
    { french: "le conservateur", english: "curator" },
    { french: "la composition", english: "composition" }
];

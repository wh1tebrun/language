...
const wordPairs = [
    ...
    { german: "die Fotografie", english: "photography" },
    { german: "das Kunstwerk", english: "artwork" },
    { german: "der Pinsel", english: "paintbrush" },
    { german: "die Leinwand", english: "canvas" },
    { german: "die Farbe", english: "color/paint" },
    { german: "das Aquarell", english: "watercolor" },
    { german: "die Collage", english: "collage" },
    { german: "das Porträt", english: "portrait" },
    { german: "die Ausstellung", english: "exhibition" },
    { german: "die Galerie", english: "gallery" },
    { german: "der Kunststil", english: "art style" },
    { german: "der Realismus", english: "realism" },
    { german: "der Impressionismus", english: "impressionism" },
    { german: "der Expressionismus", english: "expressionism" },
    { german: "der Surrealismus", english: "surrealism" },
    { german: "die Abstrakte Kunst", english: "abstract art" },
    { german: "die Moderne Kunst", english: "modern art" },
    { german: "das Stillleben", english: "still life" },
    { german: "die Bildhauerei", english: "sculpture (craft)" },
    { german: "die Installation", english: "installation" },
    { german: "die Performance", english: "performance" },
    { german: "das Kunstmuseum", english: "art museum" },
    { german: "die Ästhetik", english: "aesthetics" },
    { german: "das Design", english: "design" },
    { german: "der Kubismus", english: "cubism" },
    { german: "die Avantgarde", english: "avant-garde" },
    { german: "das Mosaik", english: "mosaic" },
    { german: "die Keramik", english: "ceramics" },
    { german: "die Bildende Kunst", english: "fine arts" },
    { german: "die Kunstgeschichte", english: "art history" },
    { german: "das Fresko", english: "fresco" },
    { german: "der Kunstkritiker", english: "art critic" },
    { german: "die Inspiration", english: "inspiration" },
    { german: "die Kreativität", english: "creativity" },
    { german: "das Atelier", english: "studio" },
    { german: "das Selbstporträt", english: "self-portrait" },
    { german: "die Grafik", english: "graphic" },
    { german: "die Skizze", english: "sketch" },
    { german: "der Holzschnitt", english: "woodcut" },
    { german: "der Entwurf", english: "draft/design" },
    { german: "das Plakat", english: "poster" },
    { german: "das Graffiti", english: "graffiti" },
    { german: "der Kurator", english: "curator" },
